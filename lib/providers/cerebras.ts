...
// Cerebras deprecated llama3.1-8b and llama-3.3-70b — their current public
// lineup is much smaller than it used to be. gpt-oss-120b is confirmed live.
const DEFAULT_TEXT_MODEL = "gpt-oss-120b"
const DEFAULT_CODE_MODEL = "gpt-oss-120b"
  ...
  async chat(
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(`Cerebras returned ${res.status}: ${errText}`)
      }
